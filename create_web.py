...
class Window(QMainWindow):
	def __init__(self, *args, **kwargs):
		...
		pythongeeks = QAction("HBeey", self)
		pythongeeks.setStatusTip("Go to HBeey website")
		pythongeeks.triggered.connect(lambda: self.go_to_URL(QUrl("https://HBeey.org")))
...
app.setApplicationName('HBeey Web Browser')
